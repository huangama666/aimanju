            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
              ...
              <Card className="text-center card-tomato hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-lg font-tomato-title font-semibold mb-4 text-tomato-text">码上做剧本</h3>
                  <p className="text-sm text-tomato-text-light leading-tomato">
              ...
              <Card className="text-center card-tomato hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-lg font-tomato-title font-semibold mb-4 text-tomato-text">码上拍戏</h3>
